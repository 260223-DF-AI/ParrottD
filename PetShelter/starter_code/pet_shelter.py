...
class Kitten(Cat):
    ...
    def __init__(self, name, age_months, color):
        ...
        base = super().__init__(name, age_years ,color)
...
def main():
    ...
    # TODO: Add a Cat
    shelter.add_animal(Cat("Pal", 2, "Black", True))
    # TODO: Add a Puppy
    shelter.add_animal(Puppy("Rex", 9, "Bulldog"))
    # TODO: Add a ServiceDog
    shelter.add_animal(ServiceDog("Spike", 3, "Golden Retriever", "Mental Health"))
    # TODO: Add a Kitten
    shelter.add_animal(Kitten("Tutu", 11, "White"))
